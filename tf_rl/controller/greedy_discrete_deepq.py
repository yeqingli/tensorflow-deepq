...
from tf_rl.controller import GreedyController

class GreedyDiscreteDeepQ(object):
    def __init__(self, observation_size,
        ...
        self.trainer = GreedyController({b"w": 3, b"d": 0, b"s": 1,b"a": 2,}, 32)
    ...
    def action(self, observation):
        ...
        if random.random() < exploration_p:
            ...
            return self.trainer.action(observation)
        else:
